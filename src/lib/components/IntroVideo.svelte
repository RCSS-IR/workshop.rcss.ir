...
<div class="main-container">
  <div class="flex flex-col gap-2">
    <h3 class="font-bold text-3xl gradient-text-01">شبیه‌سازی دوبعدی فوتبال چیست؟</h3>
    <p class="text-md w-full md:w-[400px] text-justify text-gray-600">
      این ویدیو ارائه‌ی سال ۹۹-۹۸ در مورد شبیه‌سازی دوبعدی فوتبال است که در آن به معرفی مفاهیم اولیه‌ی محیط شبیه سازی
      دوبعدی فوتبال میپردازیم.
    </p>
  </div>
  ...
  <div>
    {#if videoState === "IMAGE"}
      <button class="relative group" on:click={() => changeVideoState("CHOOSE")}>
        <img
          src="/img/2d-intro-background.png"
          alt="2d-intro-background"
    ...
    {:else if videoState === "CHOOSE"}
      <div
        class="flex flex-row gap-2 justify-center items-center video-size border border-2 border-gray-700 group-hover:opacity-50 transition-opacity duration-300 rounded-lg shadow-lg"
      >
        <button
        ...
        <button
          class=" h-20 w-20 p-4 flex flex-col items-center justify-center hover:bg-gray-200 transition-colors duration-300 rounded-lg"
    ...
    {:else if videoState === "YOUTUBE"}
      <div class="video-size">
        <iframe
          src="https://www.youtube.com/embed/RvktEzH4glA?si=vr5dtHeeEKdjJmep"
    ...
    {:else if videoState === "APARAT"}
      <div class="h_iframe-aparat_embed_frame bg-gray-600 video-size rounded-md overflow-hidden">
        <iframe
          src="https://www.aparat.com/video/video/embed/videohash/y0Sa7/vt/frame"
          class="video-size"
